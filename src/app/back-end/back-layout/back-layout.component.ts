import { Component, OnInit, Inject, Renderer2, AfterViewInit, OnDestroy, ChangeDetectionStrategy, ChangeDetectorRef, HostListener } from "@angular/core";
...
export class BackLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
