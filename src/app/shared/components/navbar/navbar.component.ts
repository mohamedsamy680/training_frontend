...
export class NavbarComponent extends BackBaseComponent implements OnInit, AfterViewInit, OnDestroy {
  currentLang = "en";
  selectedLanguageText = "English";
  selectedLanguageFlag = "./assets/img/flags/us.png";
  toggleClass = "ft-maximize";
  placement = "bottom-right";
  logoUrlM = 'assets/img/logomashura.png';
  logoUrl = 'assets/img/logomashura.png';
  menuPosition = 'Side';
  isSmallScreen = false;
  ...
  onChange() {
    this.openAddEdit<any>(ChangePasswordComponent, null).subscribe(response => {
